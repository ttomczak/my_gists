...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { imie: @gist.imie, nazwisko: @gist.nazwisko, numeralbumu: @gist.numeralbumu }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { imie: @gist.imie, nazwisko: @gist.nazwisko, numeralbumu: @gist.numeralbumu }
    assert_redirected_to gist_path(assigns(:gist))
  end
